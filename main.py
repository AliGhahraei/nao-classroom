...
def main():    
    ...
    while(nextExercise != 'Zero'):
        ...
        if nextExercise == 'One':
            ...
            #say('In this exercise you want to change the color of my friend FINCH. The code you will work with is already half done, but it is still missing the instruction that asks the user to input the value of the color that they want to assign to FINCH.', tts)
	    #time.sleep(2)
